...
public class DestroyingWeaponEventArgs : Event, IDeniableEvent, IAttackerEvent
{
    /// <summary>
    /// Used to create an instance of <see cref="DestroyingWeaponEventArgs"/>
    /// </summary>
    ...
    /// <param name="weapon">The <see cref="VehicleWeapon"/> that is being destroyed.</param>
    /// <param name="isAllowed">Whether the event is allowed to execute or not.</param>
    public DestroyingWeaponEventArgs(Player attacker, Player player, VehicleWeapon weapon, CustomDamageHandler damageHandler, bool isAllowed = true)
    {
        Attacker = attacker;
        Player = player;
        Weapon = weapon;
    ...
    /// <summary>
    /// The vehicle weapon being destroyed.
    /// </summary>
